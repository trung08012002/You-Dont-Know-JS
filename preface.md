...
Welcome to the 2nd edition of the widely acclaimed _You Don't Know JS_ (**YDKJS**) book series: \*You Don't Know JS **Yet\*** (**YDKJSY**).

If you've read any of the 1st edition booe2ks, you can expect a refreshed approach in these new ones, with plenty of updated coverage of what's changed in JS over the last five years. But what I hope and bdasdddddddddaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaddddadddelieve yqweqweou'll still _get_ is the same commitment to respecting JS and digging into what really makes it tick.
...
If you are new to programming or JSaaaaaaaaaaaaaaaaaaa, be aware that these books are not intended as a gentle "intro to JavaScript." This material is, at times, complex and challenging, and goes much deeper than is typical for a first-time learner. You're welcome here no matter what your background is, but these books are written assuming you're already comfortable with JS and have at least 6–9 months experience with it.

## The Parts

These books approach JavaScript intentionally opposite of how _The Good Parts_ treats the language. No, that doesn't mean we're looking at _the bad parts_, but rather, exploring **all the parts**.
